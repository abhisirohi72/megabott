...
use App\Http\Controllers\Admin\Liverage\LiverageController;
...
Route::namespace('Admin')->prefix('admin')->name('admin.')->middleware('installer')->group(function () {
    ...
    Route::middleware(['admin', 'demo'])->group(function () {
        ...
        Route::prefix('users')->name('user.')->group(function () {
            ...
            Route::get('/edit_id/{id}', [UserController::class, 'verifyUserEmail'])->name('verifyUserEmail');
        ...
        Route::prefix('investments')->name('binary.')->group(function () {
            ...
            //Liverage
            Route::prefix('liverage/')->name('liverage.')->group(function () {
                Route::get('/', [LiverageController::class, 'index'])->name('index');
                Route::post('/add', [LiverageController::class, 'add'])->name('add');
                Route::get('/view', [LiverageController::class, 'view'])->name('view');
                Route::get('/update/{liverage_id}/{user_id}/{status}', [LiverageController::class, 'update'])->name('update');
                Route::get('/liverage_setting', [LiverageController::class, 'liverageSetting'])->name('liverage.setting');
                Route::get('/liverage_connection', [LiverageController::class, 'liverageConnection'])->name('liverage.connection');
                Route::post('/add_setting', [LiverageController::class, 'addSetting'])->name('add_setting');
                Route::post('/save_connection', [LiverageController::class, 'saveConnection'])->name('connection.save');
            });
        ...
        Route::prefix('trades')->name('trade.')->namespace('Trade')->group(function () {
            ...
            Route::get('abhishek', [ActivityController::class, 'abhiTradeLogs'])->name('abhiTradeLogs');
            Route::post('crypto_save', [ActivityController::class, 'cryptoSave'])->name('cryptoSave');

            Route::post('stop_crypto_save', [ActivityController::class, 'stopCryptoSave'])->name('stopCryptoSave');
            Route::get("abhi_cron", [ActivityController::class, 'abhiCron'])->name("abhi.cron.send");

            Route::post('trade_logs', [ActivityController::class, 'addTradeLogs'])->name('addTradeLogs');
            Route::get('create_logs', [ActivityController::class, 'createLogs'])->name('createLogs');
        ...
        //Payment Method
        Route::prefix('crypto_payment')->name('crypto.payment.')->group(function () {
            // echo "abhi";
            // exit;
            Route::get('/',[CryptoPaymentController::class, 'cryptoPaymentRecieving'])->name('crypto_payment_recieving');
            Route::get('edit/{id}',[CryptoPaymentController::class, 'editCryptoPaymentRecieving'])->name('edit');

            Route::get('delete/{id}',[CryptoPaymentController::class, 'deleteCryptoPaymentRecieving'])->name('delete');
            
            Route::post('/store',[CryptoPaymentController::class, 'cryptoPaymentStore'])->name('store');
        });
        ...
        Route::prefix('settings')->name('setting.')->group(function () {
            ...
            Route::get('/add_currency', [SettingController::class, 'addCurrency'])->name('add_currency');
            Route::get('/add_notification', [SettingController::class, 'addNotification'])->name('add_notification');
            Route::post('/save_currency', [SettingController::class, 'saveCurrency'])->name('save_currency');
            Route::post('/save_notification', [SettingController::class, 'saveNotification'])->name('save_notification');
            Route::get('/view_notification', [SettingController::class, 'viewNotification'])->name('view_notification');
            Route::get('/edit_notification/{id}', [SettingController::class, 'editNotification'])->name('edit_notification');
            Route::post('/update_notification', [SettingController::class, 'updateNotification'])->name('update_notification');
            Route::get('/delete_notification/{id}', [SettingController::class, 'deleteNotification'])->name('delete_notification');
            Route::get('/send_notification', [SettingController::class, 'sendNotification'])->name('send_notification');
            Route::post('/send_mail_notification', [SettingController::class, 'sendMailNotification'])->name('send_mail_notification');
            Route::get('/whatsapp', [SettingController::class, 'whatsApp'])->name('whatsapp');
            Route::post('/update_whatsapp', [SettingController::class, 'updateWhatsapp'])->name('update_whatsapp');
        });
