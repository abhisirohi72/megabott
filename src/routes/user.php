...
Route::prefix('users/')->name('user.')->middleware(['auth', 'verified', 'firewall.all', 'installer'])->group(function () {
    ...
    Route::get('/show_liverage',[InvestmentController::class, 'showLiverage'])->name('show_liverage');
    Route::get('/purchase_liverage/{id}',[InvestmentController::class, 'purchaseLiverage'])->name('purchase_liverage');
    ...
    Route::prefix('trades')->name('trade.')->group(function () {
        ...
        Route::post('update_switch_status', [TradeController::class, 'updateSwitchStatus'])->name('update-switch-status');
