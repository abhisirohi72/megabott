...
class ActivityLogService
{
    ...
    public function getByUser(int $userId, TradeType $tradeType, bool $isLimit = false, $type=""): AbstractPaginator|Collection
    {
        if($type=="2"){
            $query = TradeLog::filter(request()->all())
