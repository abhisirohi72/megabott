                ...
                <div class="user-form">
                    ...
                    <div class="card-body mb-4 mt-2">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="{{ displayImage($gateway->qr_code) }}" style="width: 300px; height:300px;">
                            </div>
                            <div class="col-md-4"></div>
                        </div>
                                ...
                                @if($gateway->qr_code!="")
                                    <div class="col-lg-12">
                                        <div class="form-inner">
                                            ...
                                            <input type="text" id="Trx" name="trx" placeholder="Enter Trx" required="">
                                        </div>
                                    </div>
                                    
                                    <div class="col-lg-12">
                                        <div class="form-inner">
                                            <label for="Trx">Screenshot</label>
