                    ...
                    <form action="{{route('admin.manual.gateway.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-wrapper">
                            <div class="row mb-3 g-3">
                                ...
                                <div class="mb-3 col-lg-6">
                                    <label for="image" class="form-label"> QR Code <sup class="text--danger">*</sup></label>
                                ...
                                <div class="col-lg-12">
                                    <label for="details" class="form-label"> {{ __('Payment Details')}} <sup class="text--danger">*</sup></label>
