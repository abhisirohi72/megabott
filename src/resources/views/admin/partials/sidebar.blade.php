<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu-container" data-simplebar>
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link collapsed {{ (Request::segment(3)=='liverage') ? "active" :"" }}" data-bs-toggle="collapse" href="#collapseLiverage"
                   role="button" aria-expanded="true" aria-controls="collapseLiverage">
                    <span><i class="las la-shekel-sign"></i></span>
                    <p>Leverage<small><i class="las la-angle-down"></i></small></p>
                </a>

                <div class="side-menu-dropdown collapse {{ (Request::segment(3)=='liverage' && Request::segment(4)=='') ? "show" :"" }}"  id="collapseLiverage">
                    <ul class="sub-menu">
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link {{ (Request::segment(3)=='liverage') ? "active" :"" }}" href="{{route('admin.binary.liverage.index')}}">
                                <p>Add Leverage</p>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link {{ (Request::segment(3)=='liverage' && Request::segment(4)=='view') ? "active" :"" }}" href="{{route('admin.binary.liverage.view')}}">
                                <p>Leverage User List</p>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link {{ (Request::segment(4)=='liverage_setting') ? "active" :"" }}" href="{{route('admin.binary.liverage.liverage.setting')}}">
                                <p>Leverage Setting</p>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link {{ (Request::segment(4)=='liverage_connection') ? "active" :"" }}" href="{{route('admin.binary.liverage.liverage.connection')}}">
            ...
            <li class="sidebar-menu-item">
                ...
                <div class="side-menu-dropdown collapse {{$isPaymentGatewayActive ? "show" :"" }}"  id="collapsePaymentProcessor">
                    <ul class="sub-menu">
                        ...
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link {{ request()->routeIs('admin.crypto.payment.index') ? "active" :"" }}" href="{{route('admin.crypto.payment.crypto_payment_recieving')}}">
                                <p>{{ __('admin.payment_processor.menu.sub_menus.third.name') }}</p>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link" href="{{route('admin.setting.add_currency')}}">
                    <span><i class="las la-broom"></i></span>
                    <p>Add Currency</p>
                </a>
            </li>
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link" href="{{route('admin.setting.add_notification')}}">
                    <span><i class="las la-broom"></i></span>
                    <p>Add Notification</p>
                </a>
            </li>
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link" href="{{route('admin.setting.view_notification')}}">
                    <span><i class="las la-broom"></i></span>
                    <p>View Notification</p>
                </a>
            </li>
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link" href="{{route('admin.setting.send_notification')}}">
                    <span><i class="las la-broom"></i></span>
                    <p>Send Notification</p>
                </a>
            </li>
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link" href="{{route('admin.setting.whatsapp')}}">
