                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-lg-12">
                                <div class="d-flex justify-content-between align-items-center flex-grow-1 bg--light p-2 w-100">
                                    <h5 class="fw-bold text--dark fs-15"><?php echo e(__('admin.user.content.trade')); ?></h5>
                                    <a href="<?php echo e(route('admin.user.trade', $user->id)); ?>" class="text--light fs-18" data-bs-toggle="tooltip" data-bs-placement="top"  data-bs-title="<?php echo e(getCurrencySymbol()); ?><?php echo e(shortAmount($trade->total)); ?>"><i class="bi bi-info-circle"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="row g-3 dash-cards">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="bg--light p-3 text-center h-100">
                                    ...
                                    <h4 class="fs-18 mb-3"><?php echo e(getCurrencySymbol()); ?><?php echo e(shortAmount(getArrayValue($statistics, 'level_commission') + getArrayValue($statistics, 'referral_commission'))); ?></h4>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-4 col-md-6 col-sm-6">
                                <div class="bg--warning-light border--warning-top p-3 text-start">
                                    ...
                                    <h4 class="fs-18"><?php echo e(getCurrencySymbol()); ?><?php echo e(shortAmount(getArrayValue($statistics, 'deposit'))); ?></h4>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-4 col-md-6 col-sm-6">
                                <div class="bg--primary-light border--primary-top p-3 text-start">
                                    ...
                                    <h4 class="fs-18"><?php echo e(getCurrencySymbol()); ?><?php echo e(shortAmount(getArrayValue($statistics, 'withdraw'))); ?></h4>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-4 col-md-6 col-sm-6">
                                <div class="bg--success-light border--success-top p-3 text-start">
                                    ...
                                    <h4 class="fs-18"><?php echo e(getCurrencySymbol()); ?><?php echo e(shortAmount(getArrayValue($statistics, 'level_commission'))); ?></h4>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-4 col-md-6 col-sm-6">
                                <div class="bg--danger-light border--danger-top p-3 text-start">
                                    ...
                                    <h4 class="fs-18"><?php echo e(getCurrencySymbol()); ?><?php echo e(shortAmount(getArrayValue($statistics, 'referral_commission'))); ?></h4>
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-item">
                                            ...
                                            <input type="text" name="address" id="address" class="form-control" value="<?php echo e(getArrayValue($user->meta, 'address.address')); ?>" placeholder="<?php echo e(__('Enter Address')); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-item">
                                            ...
                                            <input type="text" name="city" id="city" class="form-control" value="<?php echo e(getArrayValue($user->meta, 'address.city')); ?>" placeholder="<?php echo e(__('Enter City')); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-item">
                                            ...
                                            <input type="text" name="state" id="state" class="form-control" value="<?php echo e(getArrayValue($user->meta, 'address.state')); ?>" placeholder="<?php echo e(__('Enter State')); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-item">
                                            ...
                                            <input type="text" name="postcode" id="postcode" class="form-control" value="<?php echo e(getArrayValue($user->meta, 'address.postcode')); ?>" placeholder="<?php echo e(__('Enter Zip')); ?>" required>
                                        </div>
                                    </div>

                                    <div class="col-lg-6">
                                        <div class="form-item">
                                            <label for="kyc_status" class="form-label"><?php echo e(__('admin.input.kyc')); ?> <sup class="text--danger">*</sup></label>
                                            <select class="form-select" name="kyc_status" id="kyc_status">
                                                <?php $__currentLoopData = \App\Enums\Status::values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($status); ?>" <?php if( $status == $user->kyc_status): ?> selected <?php endif; ?>><?php echo e(\App\Enums\Status::getName($status)); ?></option>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/dgtec3yk/megabott.com/src/resources/views/admin/user/details.blade.php ENDPATH**/ ?>