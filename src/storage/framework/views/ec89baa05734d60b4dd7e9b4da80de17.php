<?php if(getArrayValue($setting->investment_setting, getInputName(\App\Enums\InvestmentType::STAKING_INVESTMENT->name)) == 1): ?>
    ...
    ?>
    <section class="investment-section bg--dark pt-120 pb-120">
        <div class="banner-blur"></div>
        <div class="container-fluid container-wrapper">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title title-secondary text-center b-0">
                                ...
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="text-sm-end text-center">
                                            <button class="i-btn btn--primary btn--md pill invest-process staking-investment-process" data-bs-toggle="modal" data-bs-target="#staking-investment"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-dark">
                    <h5 class="modal-title text-white"><?php echo e(__('Staking Invest Now')); ?></h5>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /home2/dgtec3yk/megabott.com/src/resources/views/blue_theme/component/staking-investment.blade.php ENDPATH**/ ?>