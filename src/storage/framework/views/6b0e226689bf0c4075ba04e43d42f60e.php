<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu-container" data-simplebar>
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link collapsed <?php echo e((Request::segment(3)=='liverage') ? "active" :""); ?>" data-bs-toggle="collapse" href="#collapseLiverage"
                   role="button" aria-expanded="true" aria-controls="collapseLiverage">
                    <span><i class="las la-shekel-sign"></i></span>
                    <p>Leverage<small><i class="las la-angle-down"></i></small></p>
                </a>

                <div class="side-menu-dropdown collapse <?php echo e((Request::segment(3)=='liverage' && Request::segment(4)=='') ? "show" :""); ?>"  id="collapseLiverage">
                    <ul class="sub-menu">
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link <?php echo e((Request::segment(3)=='liverage') ? "active" :""); ?>" href="<?php echo e(route('admin.binary.liverage.index')); ?>">
                                <p>Add Leverage</p>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link <?php echo e((Request::segment(3)=='liverage' && Request::segment(4)=='view') ? "active" :""); ?>" href="<?php echo e(route('admin.binary.liverage.view')); ?>">
                                <p>Leverage User List</p>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link <?php echo e((Request::segment(4)=='liverage_setting') ? "active" :""); ?>" href="<?php echo e(route('admin.binary.liverage.liverage.setting')); ?>">
                                <p>Leverage Setting</p>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link <?php echo e((Request::segment(4)=='liverage_connection') ? "active" :""); ?>" href="<?php echo e(route('admin.binary.liverage.liverage.connection')); ?>">
                                <p>Leverage Connection</p>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="sidebar-menu-item">
                ...
                <div class="side-menu-dropdown collapse <?php echo e($isPaymentGatewayActive ? "show" :""); ?>"  id="collapsePaymentProcessor">
                    <ul class="sub-menu">
                        ...
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link <?php echo e(request()->routeIs('admin.crypto.payment.index') ? "active" :""); ?>" href="<?php echo e(route('admin.crypto.payment.crypto_payment_recieving')); ?>">
                                <p><?php echo e(__('admin.payment_processor.menu.sub_menus.third.name')); ?></p>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link" href="<?php echo e(route('admin.setting.add_currency')); ?>">
                    <span><i class="las la-broom"></i></span>
                    <p>Add Currency</p>
                </a>
            </li>
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link" href="<?php echo e(route('admin.setting.add_notification')); ?>">
                    <span><i class="las la-broom"></i></span>
                    <p>Add Notification</p>
                </a>
            </li>
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link" href="<?php echo e(route('admin.setting.view_notification')); ?>">
                    <span><i class="las la-broom"></i></span>
                    <p>View Notification</p>
                </a>
            </li>
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link" href="<?php echo e(route('admin.setting.send_notification')); ?>">
                    <span><i class="las la-broom"></i></span>
                    <p>Send Notification</p>
                </a>
            </li>
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link" href="<?php echo e(route('admin.setting.whatsapp')); ?>">
                    <span><i class="lab la-whatsapp"></i></span>
                    <p>What's App Setting</p>
                </a>
            </li>
        </ul>
    </div>
...
<?php /**PATH /home2/dgtec3yk/megabott.com/src/resources/views/admin/partials/sidebar.blade.php ENDPATH**/ ?>