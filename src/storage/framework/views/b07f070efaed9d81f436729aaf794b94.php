        ...
        <div class="row gy-5 align-items-stretch">
            <div class="col-xl-6 col-lg-6">
                <div class="banner-content" data-aos="fade-right">
                    ...
                    <span class="banner-subtitle"> <?php echo e(__(getArrayValue($fixedContent?->meta, 'blue_theme_title'))); ?></span>
                    <h1 class="banner-title">
                        <?php echo e(__(getArrayValue($fixedContent?->meta, 'heading'))); ?>

                    </h1>
                    <p class="banner-description"><?php echo e(__(getArrayValue($fixedContent?->meta, 'sub_heading'))); ?></p>
                    <div class="banner-actions">
                        <a href="<?php echo e(__(getArrayValue($fixedContent?->meta, 'btn_url'))); ?>" class="i-btn btn--primary btn--xl pill"><?php echo e(__(getArrayValue($fixedContent?->meta, 'btn_name'))); ?></a>
                        <div class="d-flex align-items-center gap-2">
                            <span class="world-icon"><i class="bi bi-globe2"></i></span>
                            <div class="text">
                                <p class="fs-16 fw-semibold"><?php echo e(__(getArrayValue($fixedContent?->meta, 'first_text'))); ?></p>
                                <p class="fs-12 opacity-75"><?php echo e(__(getArrayValue($fixedContent?->meta, 'second_text'))); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-5 offset-xl-1 col-lg-6">
                <div class="banner-img" data-aos="fade-left">
                    ...
                    <img src="<?php echo e(displayImage(getArrayValue($fixedContent?->meta, 'main_image'), '593x586')); ?>" alt="mockup" />
                ...
                <div class="providers">
                    <div class="swiper providers-slider">
                        <div class="swiper-wrapper">
                            <?php $__currentLoopData = $enhancementContents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enhancementContent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide">
                                    <img src="<?php echo e(displayImage(getArrayValue($enhancementContent->meta, 'blue_theme_image'), "800x160")); ?>" alt="<?php echo e(__('banner-coin3')); ?>"/>
                                </div>
...
<?php /**PATH /home2/dgtec3yk/megabott.com/src/resources/views/blue_theme/component/banner.blade.php ENDPATH**/ ?>