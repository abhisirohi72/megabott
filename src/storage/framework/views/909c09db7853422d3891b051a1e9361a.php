                    ...
                    <ul class="mt-4 d-flex flex-column gap-4">
                        <?php $__currentLoopData = $enhancementContents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $enhancementContent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="d-flex align-items-center gap-3 lh-base fw-normal text-white">
                                <i class="bi bi-check-circle text-primary"></i><?php echo e(getArrayValue($enhancementContent->meta, 'title')); ?>
...
<?php /**PATH /home2/dgtec3yk/megabott.com/src/resources/views/blue_theme/component/advertise.blade.php ENDPATH**/ ?>