                        ...
                        <td data-label="<?php echo e($column); ?>">
                            ...
                            <?php elseif($dbColumn == 'last_run'): ?>
                                ...
                                <?php else: ?>
                                    <span><?php echo e(showDateTime($row->$dbColumn)); ?></span>
                                <?php endif; ?>
                            <?php elseif($dbColumn == 'image'): ?>
                                <img src="<?php echo e(displayImage($row->image)); ?>" style="width: 200px;height:200px;" onclick="openModal('<?php echo e(displayImage($row->image)); ?>')">
                            ...
                            <?php elseif($dbColumn == 'verify'): ?>
                                
                                <?php if($row->email_verified_at==""): ?>
                                    <a href="<?php echo e(route('admin.user.verifyUserEmail', ['id' => $row->id])); ?>" class="badge badge--danger">Un Verify</a>
                                <?php else: ?>
...
<?php /**PATH /home2/dgtec3yk/megabott.com/src/resources/views/admin/partials/table.blade.php ENDPATH**/ ?>